...
public partial class behedit : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        comm.CommandText = "update_behavier";
        comm.Connection = con;
        SqlParameter[] co = new SqlParameter[3];
        co[0] = new SqlParameter("@1bdname", DropDownList1.SelectedItem.ToString());
        co[1] = new SqlParameter("@crs_id", DropDownList2.SelectedValue);
        co[2] = new SqlParameter("@bdname", TextBox1.Text);
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        TextBox1.Text = "";
        SqlCommand comm = new SqlCommand();
        comm.CommandText = "select beh_id,bdname from behavier where crs_id=" + DropDownList2.SelectedValue;
        comm.Connection = con;
        con.Open();
        SqlDataReader da1 = comm.ExecuteReader();
        DropDownList1.DataSource = da1;
        DropDownList1.DataTextField = "bdname";
        DropDownList1.DataValueField = "beh_id";
